...
#endif
#endif
	auto game = std::make_unique<Library::RenderingGame>("Particles [Sources experiments/strange/particles]");
	game->addComponent<Library::ClearBackground>();
	game->addService<Rendering::ParticlesUi>("assets/settings/experiments/strange/particles.xml");
