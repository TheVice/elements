...
#endif
	auto game =
		std::make_unique<Library::RenderingGame>("VelocitiesProcess [Sources experiments/air/velocities_product_process]");
	game->addComponent<Library::ClearBackground>();
	game->addService<Rendering::VelocitiesProcessUi>("assets/settings/experiments/air/velocities_product_process.xml");
