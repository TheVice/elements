...
#endif
	auto game =
		std::make_unique<Library::RenderingGame>("PositionsProcess [Sources experiments/air/positions_product_process]");
	game->addComponent<Library::ClearBackground>();
	game->addService<Rendering::PositionsProcessUi>("assets/settings/experiments/air/positions_product_process.xml");
