...
#endif
	auto game =
		std::make_unique<Library::RenderingGame>("PositionsReset [Sources experiments/air/positions_product_reset]");
	game->addComponent<Library::ClearBackground>();
	game->addService<Rendering::PositionsResetUi>("assets/settings/experiments/air/positions_product_reset.xml");
	game->addComponent<Rendering::PositionsResetDemo>();
