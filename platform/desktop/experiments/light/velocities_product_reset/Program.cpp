...
#endif
	auto game =
		std::make_unique<Library::RenderingGame>("VelocitiesReset [Sources experiments/light/velocities_product_reset]");
	game->addComponent<Library::ClearBackground>();
	game->addService<Rendering::VelocitiesResetUi>("assets/settings/experiments/light/velocities_product_reset.xml");
