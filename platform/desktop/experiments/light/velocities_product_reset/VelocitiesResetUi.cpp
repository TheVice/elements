...
#include "VelocitiesResetControls.h"
#include <checkbox.h>
...
namespace Rendering
{
RTTI_DEFINITIONS(VelocitiesResetUi)

VelocitiesResetUi::VelocitiesResetUi(Library::Game& aGame, const std::string& aAssetPath) :
...
VelocitiesResetUi::~VelocitiesResetUi() = default;

bool VelocitiesResetUi::Initialize()
{
...
void VelocitiesResetUi::SetVertices(const std::vector<VelocitiesResetVertex>& aVertices)
{
	mVertices = aVertices;
	//
...
const std::vector<VelocitiesResetVertex>& VelocitiesResetUi::GetVertices() const
{
	return mVertices;
}

bool VelocitiesResetUi::IsNeedRestore() const
{
	return mIsRestoreNeed;
}

float& VelocitiesResetUi::GetValueBySliderId(int aSliderId)
{
	switch (aSliderId)
	{
