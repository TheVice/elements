...
#endif
#endif
	auto game = std::make_unique<Library::RenderingGame>("Particles [Sources experiments/light/particles]");
	game->addComponent<Library::ClearBackground>();
	game->addService<Rendering::ParticlesUi>("assets/settings/experiments/light/particles.xml");
