...
#endif
	auto game =
		std::make_unique<Library::RenderingGame>("VelocitiesProcess [Sources experiments/light/velocities_product_process]");
	game->addComponent<Library::ClearBackground>();
	game->addService<Rendering::VelocitiesProcessUi>("assets/settings/experiments/light/velocities_product_process.xml");
	game->addComponent<Rendering::VelocitiesProcessDemo>();
