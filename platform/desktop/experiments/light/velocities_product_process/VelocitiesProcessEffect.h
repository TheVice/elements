#ifndef _VELOCITIES_PROCESS_EFFECT_H_
#define _VELOCITIES_PROCESS_EFFECT_H_
...
{
public:
	explicit VelocitiesProcessEffect(const std::vector<VelocitiesProcessVertex>& vertices,
									 const std::vector<GLubyte>& indices,
									 eps::rendering::buffer_usage usage = eps::rendering::buffer_usage::STATIC_DRAW);

	void construct(const std::vector<VelocitiesProcessVertex>& vertices);
