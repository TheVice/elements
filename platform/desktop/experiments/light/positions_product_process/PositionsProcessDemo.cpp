...
bool PositionsProcessDemo::Initialize()
{
	...
	auto assetPath = "assets/shaders/experiments/light/positions_product_process.prog";
	...
	// Load the settings
	assetPath = "assets/settings/experiments/light/positions_product_process.xml";
