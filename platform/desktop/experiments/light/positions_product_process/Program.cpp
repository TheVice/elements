...
#endif
	auto game =
		std::make_unique<Library::RenderingGame>("PositionsProcess [Sources experiments/light/positions_product_process]");
	game->addComponent<Library::ClearBackground>();
	game->addService<Rendering::PositionsProcessUi>("assets/settings/experiments/light/positions_product_process.xml");
	game->addComponent<Rendering::PositionsProcessDemo>();
