...
#endif
#endif
	auto game = std::make_unique<Library::RenderingGame>("Fire [Sources experiments/fire/fire]");
	game->addComponent<Library::ClearBackground>();
	game->addService<Rendering::FireUi>("assets/settings/experiments/fire/fire.xml");
