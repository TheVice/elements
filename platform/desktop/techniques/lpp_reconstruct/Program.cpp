...
#endif
#endif
	auto game = std::make_unique<Library::RenderingGame>("Reconstruct [Sources techniques/lpp_reconstruct]");
	game->addComponent<Library::ClearBackground>();
	game->addService<Rendering::ReconstructUi>("assets/settings/techniques/lpp_reconstruct.xml");
	game->addComponent<Rendering::ReconstructDemo>();
