...
#endif
	auto game =
		std::make_unique<Library::RenderingGame>("LppLightingStencil [Sources techniques/lpp_lighting_stencil]");
	game->addComponent<Library::ClearBackground>();
	game->addService<Rendering::LppLightingStencilUi>("assets/settings/techniques/lpp_lighting_stencil.xml");
	game->addComponent<Rendering::LppLightingStencilDemo>();
