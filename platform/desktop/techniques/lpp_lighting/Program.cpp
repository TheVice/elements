...
#endif
#endif
	auto game = std::make_unique<Library::RenderingGame>("LppLighting [Sources techniques/lpp_lighting]");
	game->addComponent<Library::ClearBackground>();
	game->addService<Rendering::LppLightingUi>("assets/settings/techniques/lpp_lighting.xml");
	game->addComponent<Rendering::LppLightingDemo>();
