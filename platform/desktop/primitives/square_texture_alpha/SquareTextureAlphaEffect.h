#ifndef _SQUARE_TEXTURE_ALPHA_EFFECT_H_
#define _SQUARE_TEXTURE_ALPHA_EFFECT_H_
...
{
public:
	explicit SquareTextureAlphaEffect(const std::vector<SquareTextureAlphaVertex>& vertices,
									  const std::vector<GLubyte>& indices,
									  eps::rendering::buffer_usage usage = eps::rendering::buffer_usage::STATIC_DRAW);

	void construct(const std::vector<SquareTextureAlphaVertex>& vertices);
