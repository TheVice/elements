...
#include "SquareColorCircleControls.h"
#include <checkbox.h>
...
namespace Rendering
{
RTTI_DEFINITIONS(SquareColorCircleUi)

SquareColorCircleUi::SquareColorCircleUi(Library::Game& aGame, const std::string& aAssetPath) :
...
SquareColorCircleUi::~SquareColorCircleUi() = default;

bool SquareColorCircleUi::Initialize()
{
...
void SquareColorCircleUi::Update()
{
	UiAsset::Update();
...
void SquareColorCircleUi::Set_u_transform(const eps::math::mat4& a_u_transform)
{
...
const eps::math::mat4& SquareColorCircleUi::Get_u_transform() const
{
	return m_u_transform;
}

void SquareColorCircleUi::Set_u_color(const eps::math::vec4& a_u_color)
{
	m_u_color = a_u_color;
	//
...
const eps::math::vec4& SquareColorCircleUi::Get_u_color() const
{
	return m_u_color;
}

void SquareColorCircleUi::SetVertices(const std::vector<SquareColorCircleVertex>& aVertices)
{
	mVertices = aVertices;
	//
...
const std::vector<SquareColorCircleVertex>& SquareColorCircleUi::GetVertices() const
{
	return mVertices;
}

bool SquareColorCircleUi::IsNeedRestore() const
{
	return mIsRestoreNeed;
}

float& SquareColorCircleUi::GetValueBySliderId(int aSliderId)
{
	switch (aSliderId)
	{
