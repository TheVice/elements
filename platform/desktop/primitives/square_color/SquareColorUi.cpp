...
namespace Rendering
{
RTTI_DEFINITIONS(SquareColorUi)

SquareColorUi::SquareColorUi(Library::Game& aGame, const std::string& aAssetPath) :
...
SquareColorUi::~SquareColorUi() = default;

bool SquareColorUi::Initialize()
{
...
void SquareColorUi::Set_u_transform(const eps::math::mat4& a_u_transform)
{
...
const eps::math::mat4& SquareColorUi::Get_u_transform() const
{
	return m_u_transform;
}

void SquareColorUi::Set_u_color(const eps::math::vec4& a_u_color)
{
	m_u_color = a_u_color;
	//
...
const eps::math::vec4& SquareColorUi::Get_u_color() const
{
	return m_u_color;
}

void SquareColorUi::SetVertices(const std::vector<SquareColorVertex>& aVertices)
{
	mVertices = aVertices;
	//
...
const std::vector<SquareColorVertex>& SquareColorUi::GetVertices() const
{
	return mVertices;
}

bool SquareColorUi::IsNeedRestore() const
{
	return mIsRestoreNeed;
}

float& SquareColorUi::GetValueBySliderId(int aSliderId)
{
	switch (aSliderId)
	{
