...
#endif
#endif
	auto game = std::make_unique<Library::RenderingGame>("Tone [Sources effects/tone]");
	game->addComponent<Library::ClearBackground>();
	game->addService<Rendering::ToneUi>("assets/settings/effects/tone.xml");
	game->addComponent<Rendering::ToneDemo>();
