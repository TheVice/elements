...
#endif
#endif
	auto game = std::make_unique<Library::RenderingGame>("GradientMapping [Sources effects/gradient]");
	game->addComponent<Library::ClearBackground>();
	game->addService<Rendering::GradientMappingUi>("assets/settings/effects/gradient.xml");
	game->addComponent<Rendering::GradientMappingDemo>();
